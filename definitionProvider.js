...
class GCLDefinitionProvider {
    /**
       ...
       */
    provideDefinition() {
        let file = fs.readFileSync("./RegLang .gcl", "utf-8")
        // console.log(file)
        ...
        const promise = new Promise((resolve) => {
            ...
            listener.enterEveryRule = function(ctx){
                let arr = []
                for(let val of ctx.children){
                    arr.push( val.constructor.name)
            ...
            listener.visitTerminal = function(ctx){
            ...
            listener.enterExpression = function (ctx) {
                ...
                let obj = {
                    text: ctx.text,
                    expressiontype: ctx.expressiontype,
            ...
            listener.enterImportDirective = async function (ctx) {
                ...
                // console.log(ctxContract)
                // console.log(ctxFunction)
